...
class LinkRepositoryTest {
    ...
    void testFindPaginatedLinks() {
        ...
        Assertions.assertEquals(2, linkRepository.findPaginated(1, 2).size());
        Assertions.assertEquals(2, linkRepository.findPaginated(2, 2).size());
    }
}